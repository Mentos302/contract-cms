	...
	<div class="container">
		...
		<div class="content">
			...
			<p>This message is to remind you that your <strong>{{ $manufacturer_name }}</strong> contract number
				...
				is expiring in <strong>30 days</strong> and must be renewed by
				<strong>{{ $expiration_date }}</strong>.
			</p>
			<p>Because some manufacturers impose reinstatement fees when a Purchase Order is received after its
				expiration date, we encourage you to send a purchase order 48 hours prior to it expiring. </p>
