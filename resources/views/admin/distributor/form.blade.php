...
@section('content')
    ...
    <div class="col-md-12">
        <form
            action="{{ isset($distributor) && $distributor->id ? route('distributor.update', $distributor->id) : route('distributor.store') }}"
            method="POST">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="text" class="form-control" name="name" placeholder="distributor name"
